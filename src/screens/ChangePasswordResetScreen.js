/**
 * Change Password Reset Screen
 * Set new password after OTP verification → logout driver
 */
...
const ChangePasswordResetScreen = ({ navigation }) => {
...
export default ChangePasswordResetScreen;
